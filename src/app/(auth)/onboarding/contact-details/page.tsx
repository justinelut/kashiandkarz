...
import { save_dealer_contact_info } from "@/lib/dealer-actions"
import type { dealer_contact_info } from "@/types/dealer"
...
export default function ContactDetailsPage() {
  ...
  const mutation = useMutation({
    mutationFn: (data: dealer_contact_info) => save_dealer_contact_info(user_id, data),
    onSuccess: () => {
      toast({
  ...
  const on_submit = (data: dealer_contact_info) => {
