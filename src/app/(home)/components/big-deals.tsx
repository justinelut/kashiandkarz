          ...
          <CarouselContent>
            {hasDeals
              ? deals.map((deal) => {
                  ...
                  return (
                    <CarouselItem key={deal.$id} className="md:basis-1/2 lg:basis-1/3 py-10">
                        ...
                        <div className="flex flex-wrap gap-1 mb-4">
                          ...
                          {deal.car_specifications?.mileage && (
                            <Badge variant="outline" className="text-xs">
                              {deal.car_specifications.mileage} {deal.car_specifications.mileage_unit || "km"}
                            </Badge>
                          )}
                        </div>
                        ...
                        <div className="mt-auto flex items-center justify-between">
                          <div>
                            ...
                            <div className="text-lg font-bold flex items-center">
                              {formattedPrice}
                              {negotiable && <Percent className="h-3.5 w-3.5 ml-1 text-[#00e1e1]" />}
                            </div>
                          </div>
                  ...
                  .map((_, index) => (
                    <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                      <div className="relative flex flex-col rounded-xl bg-gradient-to-b from-white to-gray-50 p-6 pt-10 shadow-lg h-full">
                        ...
                        <p className="text-sm text-muted-foreground">Please wait while we fetch the latest deals</p>
                        ...
                        <div className="mt-auto flex items-center justify-between">
                          ...
                          <Button size="icon" className="rounded-full bg-black/70 hover:bg-black/90">
                            <ArrowRight className="h-4 w-4" />
                          </Button>
                        </div>
                      </div>
