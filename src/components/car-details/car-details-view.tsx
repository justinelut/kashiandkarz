...
export async function CarDetailsView({ car }: { car: any }) {
  // Extract car details
  const carTitle = car.title || `${car.car_make?.name || ""} ${car.car_model || ""} (${car.year || ""})`
  ...
  const keyInfo = {
    year: car.year || "N/A",
    mileage: specs.mileage ? `${specs.mileage} ${specs.mileage_unit || "km"}` : "N/A",
    ...
    transmission: specs.transmission_type
      ? specs.transmission_type.charAt(0).toUpperCase() + specs.transmission_type.slice(1)
      : "N/A",
    fuel: specs.fuel_type ? specs.fuel_type.charAt(0).toUpperCase() + specs.fuel_type.slice(1) : "N/A",
    ...
    previousOwners: car.ownership_documentation?.previous_owners?.toString() || "N/A",
  }
  ...
  // Car highlights
  const highlights = [
    { icon: <Shield className="h-5 w-5 text-blue-500" />, text: "Fully inspected" },
    { icon: <Award className="h-5 w-5 text-amber-500" />, text: "Premium condition" },
    { icon: <ThumbsUp className="h-5 w-5 text-green-500" />, text: "Highly rated seller" },
    { icon: <Calendar className="h-5 w-5 text-purple-500" />, text: `${car.year} model` },
  ]
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <div className="flex flex-wrap items-center gap-2 mb-2">
            <Badge variant="secondary" className="bg-[#00e1e1]/10 text-[#00e1e1] font-medium">
              {carCondition}
            </Badge>
            {car.big_deal && (
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_400px]">
          <div className="space-y-8">
            ...
            <div className="space-y-8">
              ...
              {reviewStats.totalReviews > 0 ? (
                ...
                <div className="rounded-lg border bg-muted p-6 text-center">
                  <p className="mb-4">No reviews yet. Be the first to review this car!</p>
                  <Button asChild>
                    <Link href={`/car/${car.slug}/write-review`}>
                      <PenSquare className="mr-2 h-4 w-4" />
                      Write a Review
            ...
            <Card className="overflow-hidden border-none shadow-sm">
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-medium">Kashi & Karz Motors - Nairobi Showroom</h3>
                    <p className="text-sm text-muted-foreground">123 Mombasa Road, Nairobi, Kenya</p>
            ...
            <PriceInfo price={price.replace(/^KSh /, "")} description={carDescription} />
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm">
                        This vehicle comes with a comprehensive warranty package for your peace of mind.
                      </p>
                    </div>
                  </div>
                </CardContent>
            ...
            <Card className="overflow-hidden border-none shadow-sm">
              ...
              <CardContent className="p-6">
                <p className="text-sm leading-relaxed">{carDescription || "No additional notes from the seller."}</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="relative hidden lg:block">
            <div className="space-y-8 sticky top-4">
              ...
              <Card className="overflow-hidden border-none shadow-sm">
                ...
                <CardContent className="p-6">
                  <div className="mb-2 text-3xl font-bold">{price.replace(/^KSh /, "")}</div>
                  {isNegotiable && (
              ...
              <ActionButtons carId={carId} carTitle={carTitle} />
