			...
			const result = await saveReviewSubmit(
				{
					status: "published",
					availability: true,
					slug: basic_info.title.toLowerCase().replace(/\s+/g, "-").trim(),
				},
				car_id,
			);
				...
				<CardContent className="p-6">
					<div className="space-y-6">
									...
									<div className="grid grid-cols-2">
										...
										<div className="flex items-center gap-2">
											<span
												...
												style={{ backgroundColor: specifications.color.hex }}
											/>
											<span>{specifications.color.name}</span>
										</div>
									</div>
								</div>
							</div>
							...
							<div className="rounded-lg border bg-card p-4 shadow-sm">
								...
								<div className="mt-2 grid gap-4 text-sm md:grid-cols-3">
									{features.exterior_features &&
										features.exterior_features.length > 0 && (
											<div>
									...
									{features.interior_features &&
										features.interior_features.length > 0 && (
											<div>
							...
							<div className="rounded-lg border bg-card p-4 shadow-sm">
								...
								<div className="mt-2 grid gap-2 text-sm">
									...
									<div className="grid grid-cols-2">
										...
										<span>
											{pricing.installment_plans === "yes" ? "Available" : "Not Available"}
										</span>
									</div>
									<div className="grid grid-cols-2">
						...
						<div className="rounded-md bg-primary/10 p-4 text-sm text-primary">
							<p>
								By submitting this listing, you confirm that all the information
				...
				<DialogContent className="sm:max-w-md">
					<DialogHeader>
						...
						<DialogDescription className="text-center">
							Your car has been successfully listed for sale and is now visible to
							potential buyers.
						</DialogDescription>
					</DialogHeader>
